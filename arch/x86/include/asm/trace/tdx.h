...
TRACE_EVENT(tdx_module_call_enter,
	    ...
	    TP_ARGS(id, rcx, rdx, r8, r9, r10, r11, r12, r13, r14, r15),
	    TP_STRUCT__entry(
		__field(u64, id)
		__field(u64, rcx)
		__field(u64, rdx)
	    ...
	    TP_printk("id %lld rcx 0x%016llx rdx 0x%016llx r8 0x%016llx r9 0x%016llx r10 0x%016llx r11 0x%016llx r12 0x%016llx r13 0x%016llx r14 0x%016llx r15 0x%016llx",
		      __entry->id, __entry->rcx, __entry->rdx,
		      __entry->r8, __entry->r9, __entry->r10, __entry->r11,
		      __entry->r12, __entry->r13, __entry->r14, __entry->r15
		      )
	    );

TRACE_EVENT(tdx_module_call_exit,
	    TP_PROTO(u64 rax, u64 rcx, u64 rdx, u64 r8, u64 r9,
		     u64 r10, u64 r11, u64 r12, u64 r13, u64 r14, u64 r15),
	    TP_ARGS(rax, rcx, rdx, r8, r9, r10, r11, r12, r13, r14, r15),
	    TP_STRUCT__entry(
		__field(u64, rax)
		__field(u64, rcx)
		__field(u64, rdx)
	    ...
	    TP_printk("ret %lld rcx 0x%016llx rdx 0x%016llx r8 0x%016llx r9 0x%016llx r10 0x%016llx r11 0x%016llx r12 0x%016llx r13 0x%016llx r14 0x%016llx r15 0x%016llx",
