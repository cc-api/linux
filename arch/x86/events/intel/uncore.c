...
static const struct intel_uncore_init_fun lnl_uncore_init __initconst = {
	/* .cpu_init = mtl_uncore_cpu_init, */ /* XXX EDS is not ready */
...
static const struct x86_cpu_id intel_uncore_match[] __initconst = {
	...
	X86_MATCH_INTEL_FAM6_MODEL(ARROWLAKE,		&mtl_uncore_init),
	X86_MATCH_INTEL_FAM6_MODEL(ARROWLAKE_H,		&mtl_uncore_init),
	...
	X86_MATCH_INTEL_FAM6_MODEL(CLEARWATERFOREST_X,	&gnr_uncore_init),
	X86_MATCH_INTEL_FAM6_MODEL(CLEARWATERFOREST_D,	&gnr_uncore_init),
