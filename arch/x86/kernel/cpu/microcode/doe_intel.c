 ...
 *
 * @data       : Full staging control register info
 ...
 *
 * @data         : Full staging status register info
 ...
 *
 * @data : First dword of mailbox header
 * @vid  : Vendor ID
 ...
 *
 * @data : Second dword of mailbox header
 ...
 *
 * @result           : Mailbox response result for a specific command.
 ...
 * @flags            : ucode staging status flags.
 ...
 * @rsvd.............: Reserved bits.
 * @svn_info         : SVN info dword data.
 * @mcu_svn          : SVN of currently staged ucode.
 * @rsvd1            : Reserved bits.
 */
struct uc_doe_rsp {
	union {
