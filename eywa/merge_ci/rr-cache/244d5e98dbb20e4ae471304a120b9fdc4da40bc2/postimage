...
#define ARCH_PEBS_CNTR_SHIFT		35
#define ARCH_PEBS_CNTR_ALLOW		(0x01ull << ARCH_PEBS_CNTR_SHIFT)
#define ARCH_PEBS_CNTR_GP			(0x02ull << ARCH_PEBS_CNTR_SHIFT)
#define ARCH_PEBS_CNTR_FIXED		(0x04ull << ARCH_PEBS_CNTR_SHIFT)
#define ARCH_PEBS_CNTR_METRICS		(0x08ull << ARCH_PEBS_CNTR_SHIFT)
#define ARCH_PEBS_CNTR_FREERUN		(0x10ull << ARCH_PEBS_CNTR_SHIFT)
#define ARCH_PEBS_LBR_SHIFT		40
#define ARCH_PEBS_LBR			(0x3ull << ARCH_PEBS_LBR_SHIFT)
#define ARCH_PEBS_VECR_SHIFT		49
#define ARCH_PEBS_VECR_XMM		(0x1ull << ARCH_PEBS_VECR_SHIFT)
#define ARCH_PEBS_VECR_YMM		(0x2ull << ARCH_PEBS_VECR_SHIFT)
#define ARCH_PEBS_VECR_OPMASK		(0x10ull << ARCH_PEBS_VECR_SHIFT)
#define ARCH_PEBS_VECR_ZMMLH		(0x20ull << ARCH_PEBS_VECR_SHIFT)
#define ARCH_PEBS_VECR_ZMMH		(0x40ull << ARCH_PEBS_VECR_SHIFT)
#define ARCH_PEBS_VECR			(0x73ull << ARCH_PEBS_VECR_SHIFT)
...
#define MSR_IA32_PERFEVTSEL0_EXT	0x0001903
#define MSR_IA32_FIXED_CTR0_CTRL_EXT	0x00001983
...
#define VMX_BASIC_RESERVED_RANGE_2		GENMASK_ULL(57, 56)
#define VMX_BASIC_NESTED_EXCEPTION_SHIFT	58
#define VMX_BASIC_NESTED_EXCEPTION		BIT_ULL(VMX_BASIC_NESTED_EXCEPTION_SHIFT)
#define VMX_BASIC_RESERVED_RANGE_3		GENMASK_ULL(63, 59)
