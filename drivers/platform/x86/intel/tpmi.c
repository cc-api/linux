 ...
 * @locked:	When set to 1 OS can't change this register. OS never writes to
 * 		this register, so this is just for reading current status
 *
 * The structure is used to read hardware state of a TPMI feature. This information
 * can be used to decide whether OS should create devices for features or restrict to
 * read only.
 */
				    ...
				    struct tpmi_feature_state *feature_state)
{
	...
	*feature_state = *(struct tpmi_feature_state *)&data;
