...
#define MTL_PMT_DMU_TELE_ID		0x605545
...
const struct pmc_bit_map mtl_pchs_ltr_show_map[] = {
	{"SOUTHPORT_A",		CNP_PMC_LTR_SPA},
	{"SOUTHPORT_B",		CNP_PMC_LTR_SPB},
	{"SATA",		CNP_PMC_LTR_SATA},
	{"GIGABIT_ETHERNET",	CNP_PMC_LTR_GBE},
...
const struct pmc_bit_map mtl_pchs_clocksource_status_map[] = {
	{"AON2_OFF_STS",                 BIT(0)},
	{"AON3_OFF_STS",                 BIT(1)},
	{"AON4_OFF_STS",                 BIT(2)},
...
const struct pmc_bit_map mtl_pchs_power_gating_status_0_map[] = {
	{"PMC_PGD0_PG_STS",              BIT(0)},
	{"DMI_PGD0_PG_STS",              BIT(1)},
	{"ESPISPI_PGD0_PG_STS",          BIT(2)},
	{"XHCI_PGD0_PG_STS",             BIT(3)},
...
const struct pmc_bit_map mtl_pchs_power_gating_status_1_map[] = {
	{"USBR0_PGD0_PG_STS",            BIT(0)},
	{"SUSRAM_PGD0_PG_STS",           BIT(1)},
	{"SMT1_PGD0_PG_STS",             BIT(2)},
...
const struct pmc_bit_map mtl_pchs_power_gating_status_2_map[] = {
...
const struct pmc_bit_map mtl_pchs_d3_status_0_map[] = {
	{"SPF_D3_STS",                   BIT(0)},
	{"LPSS_D3_STS",                  BIT(3)},
	{"XDCI_D3_STS",                  BIT(4)},
	{"XHCI_D3_STS",                  BIT(5)},
...
const struct pmc_bit_map mtl_pchs_d3_status_1_map[] = {
	{"GBETSN1_D3_STS",               BIT(14)},
	{"GBE_D3_STS",                   BIT(19)},
	{"ITSS_D3_STS",                  BIT(23)},
	{"P2S_D3_STS",                   BIT(24)},
...
const struct pmc_bit_map mtl_pchs_d3_status_2_map[] = {
	{"CSMERTC_D3_STS",               BIT(1)},
	{"SUSRAM_D3_STS",                BIT(2)},
	{"CSE_D3_STS",                   BIT(4)},
	{"KVMCC_D3_STS",                 BIT(5)},
...
const struct pmc_bit_map mtl_pchs_d3_status_3_map[] = {
	{"ESE_D3_STS",                   BIT(3)},
	{"GBETSN_D3_STS",                BIT(13)},
	{"THC0_D3_STS",                  BIT(14)},
	{"THC1_D3_STS",                  BIT(15)},
...
const struct pmc_bit_map mtl_pchs_vnn_req_status_0_map[] = {
	{"FIA_VNN_REQ_STS",              BIT(17)},
	{"ESPISPI_VNN_REQ_STS",          BIT(18)},
	{}
};

const struct pmc_bit_map mtl_pchs_vnn_req_status_1_map[] = {
	{"NPK_VNN_REQ_STS",              BIT(4)},
	{"DFXAGG_VNN_REQ_STS",           BIT(8)},
	{"EXI_VNN_REQ_STS",              BIT(9)},
	{"GBE_VNN_REQ_STS",              BIT(19)},
...
const struct pmc_bit_map mtl_pchs_vnn_req_status_2_map[] = {
...
const struct pmc_bit_map mtl_pchs_vnn_req_status_3_map[] = {
...
const struct pmc_bit_map mtl_pchs_vnn_misc_status_map[] = {
	{"CPU_C10_REQ_STS",              BIT(0)},
	{"TS_OFF_REQ_STS",               BIT(1)},
	{"PNDE_MET_REQ_STS",             BIT(2)},
	{"PCIE_DEEP_PM_REQ_STS",         BIT(3)},
...
const struct pmc_bit_map mtl_pchs_signal_status_map[] = {
	{"LSX_Wake0_STS",             BIT(0)},
	{"LSX_Wake1_STS",             BIT(1)},
	{"LSX_Wake2_STS",             BIT(2)},
	{"LSX_Wake3_STS",             BIT(3)},
...
const struct pmc_bit_map *mtl_pchs_lpm_maps[] = {
	mtl_pchs_clocksource_status_map,
	mtl_pchs_power_gating_status_0_map,
	mtl_pchs_power_gating_status_1_map,
	mtl_pchs_power_gating_status_2_map,
	mtl_pchs_d3_status_0_map,
	mtl_pchs_d3_status_1_map,
	mtl_pchs_d3_status_2_map,
	mtl_pchs_d3_status_3_map,
	mtl_pchs_vnn_req_status_0_map,
	mtl_pchs_vnn_req_status_1_map,
	mtl_pchs_vnn_req_status_2_map,
	mtl_pchs_vnn_req_status_3_map,
	mtl_pchs_vnn_misc_status_map,
	mtl_pchs_signal_status_map,
	NULL
};

const struct pmc_reg_map mtl_pchs_reg_map = {
	.pfear_sts = ext_mtl_socs_pfear_map,
	.ppfear_buckets = MTL_SOCS_PPFEAR_NUM_ENTRIES,
	.pm_read_disable_bit = CNP_PMC_READ_DISABLE_BIT,
	.ltr_ignore_max = MTL_SOCS_NUM_IP_IGN_ALLOWED,
	.lpm_sts = mtl_socs_lpm_maps,
	.ltr_show_sts = mtl_pchs_ltr_show_map,
	.slp_s0_offset = CNP_PMC_SLP_S0_RES_COUNTER_OFFSET,
	.slp_s0_res_counter_step = TGL_PMC_SLP_S0_RES_COUNTER_STEP,
	.lpm_res_counter_step_x2 = TGL_PMC_LPM_RES_COUNTER_STEP_X2,
	.msr_sts = msr_map,
	.ltr_ignore_offset = CNP_PMC_LTR_IGNORE_OFFSET,
	.regmap_length = MTL_PCH_PMC_MMIO_REG_LEN,
	.ppfear0_offset = CNP_PMC_HOST_PPFEAR0A,
	.pm_cfg_offset = CNP_PMC_PM_CFG_OFFSET,
	.lpm_priority_offset = MTL_LPM_PRI_OFFSET,
	.lpm_en_offset = MTL_LPM_EN_OFFSET,
...
static void mtl_punit_pmt_init(struct pmc_dev *pmcdev)
{
	...
	ep = pmt_telem_register_fixed_endpoint(pcidev, MTL_PMT_DMU_TELE_ID, 0);
	if (IS_ERR(ep)) {
