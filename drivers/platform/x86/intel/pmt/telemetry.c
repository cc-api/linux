...
EXPORT_SYMBOL_NS_GPL(pmt_telem_get_next_endpoint, INTEL_PMT);
...
EXPORT_SYMBOL_NS_GPL(pmt_telem_register_endpoint, INTEL_PMT);
...
EXPORT_SYMBOL_NS_GPL(pmt_telem_unregister_endpoint, INTEL_PMT);
