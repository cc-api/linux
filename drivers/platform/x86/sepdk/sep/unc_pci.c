 ...
 */
static VOID
unc_pci_Enable_PMU(PVOID param)
{
	U32       dev_idx;
	U32       this_cpu;
	CPU_STATE pcpu;
 ...
 */
static VOID
unc_pci_Disable_PMU(PVOID param)
{
	U32       dev_idx;
	U32       this_cpu;
	CPU_STATE pcpu;
 ...
 */
static VOID
unc_pci_Trigger_Read(PVOID param, U32 id, U32 read_from_intr)
{
	U32  this_cpu    = 0;
	U32  package_num = 0;
	U32  dev_node    = 0;
 ...
 */
static VOID
unc_pci_Read_PMU_Data(PVOID param, U32 dev_idx)
{
	U32       j = 0;
	U32       this_cpu;
