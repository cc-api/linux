 ...
 */
static PMU_MSR_INFO_NODE uncore_8[] = {
	{ 0x2FF0 }, { 0x700 }, { 0x3FED }, { 0x0 }
};

/* client - MGL global ctrl
 */
static PMU_MSR_INFO_NODE uncore_9[] = {
	{0x200E}, {0x240E}, {0x0}
};
...
/* client - MTL
 */
static PMU_MSR_INFO_NODE pmu1_10[] = {
	{0x2442, 0, 0, 1, 0x396, 0x1F, 16, 7},
	{0x2042, 0, 0x17}, {0x0}
};
...
/* server - HSX, BDX-DE, BDX, SKX, Avoton, Denverton, ICX
 */
...
/* server -  HSX, SKX, Avoton, Denverton, ICX
 */
static PMU_MSR_INFO_NODE pmu9_2[] = { { 0x639 }, { 0x0 } };

/* server - HSX, BDX-DE, BDX, SKX, ICX
 */
...
static PMU_MSR_INFO_NODE pmu10_1[] = {
	...
	{ 0xAD0, 0, 0x9 }, { 0xAF0, 0, 0x9 }, { 0xB10, 0, 0x9 },
	{ 0x0 }
};
...
/*************************************************************************************************************************/
// CHACMS, CMS - register addresses are intermixed
...
/* server - GNR
*/
static PMU_MSR_INFO_NODE pmu15[] = {
	{0x2C00, 0, 0x13B}, { 0x0 }
};
...
static PMU_MSR_INFO_NODE *skx_msr_list[] = {
	...
	pmu4_1,  pmu6_1,   pmu8_1,             pmu8_2, pmu9_1, pmu9_2,  pmu9_3,
	pmu12_1, uncore_2, pmu5_msr_reg_list1, 0
};
...
static PMU_MSR_INFO_NODE *plat2_msr_list[] = {
	core_1, core_2, core_3,   core_4,   core_6, core_7, core_11,
	pmu2_3, pmu4_2, uncore_2, uncore_5, pmu13,  0
};
...
static PMU_MSR_INFO_NODE *plat7_msr_list[] = {
	...
	pmu8_7,   pmu9_1, pmu9_2, pmu9_3, pmu9_19, pmu9_20, pmu12_5, pmu14_2,
	uncore_8, 0
};
