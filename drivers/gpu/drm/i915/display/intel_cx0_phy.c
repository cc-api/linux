				  ...
				  struct intel_encoder *encoder)
{
	...
	intel_cx0_rmw(i915, encoder->port, owned_lane_mask, PHY_C20_VDR_CUSTOM_WIDTH,
	...
	if (dp) {
		intel_cx0_rmw(i915, encoder->port, owned_lane_mask, PHY_C20_VDR_CUSTOM_SERDES_RATE,
