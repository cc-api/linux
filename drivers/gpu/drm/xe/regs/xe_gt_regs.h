...
#define IOSF_CFG				XE_REG(0x51e4)
#define   MAX_READ_REQUEST_SIZE			REG_GENMASK(5, 3)
#define   MAX_READ_REQUEST_128B			REG_FIELD_PREP(MAX_READ_REQUEST_SIZE, 0)
...
#define   NUM_SS_PER_SLICE			REG_GENMASK(30, 26)
...
#define XE3P_GT_GEOMETRY_DSS_3			XE_REG(0x915c)
#define XE3P_GT_COMPUTE_DSS_3			XE_REG(0x9160)
