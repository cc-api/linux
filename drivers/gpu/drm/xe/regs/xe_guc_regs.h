...
#define GUC_SHIM_CONTROL2			XE_REG(0xc068)
#define   GUC_SHA_COMPUTATION_DISABLE		REG_BIT(0)
#define   GUC_RSA_CHECK_BOOT_ROM_DISABLE	REG_BIT(1)
#define   GUC_RSA_KEY_SELECTION			REG_BIT(2)
