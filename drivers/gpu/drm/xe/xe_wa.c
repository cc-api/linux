...
static const struct xe_rtp_entry_sr gt_was[] = {
	...
	{ XE_RTP_NAME("16018196332"),
	  XE_RTP_RULES(PLATFORM(FSG), PRESILICON(XE_PRESI_MODE_EMULATOR_PIPEGT)),
...
static const struct xe_rtp_entry_sr engine_was[] = {
	...
	{ XE_RTP_NAME("16018712365"),
	  XE_RTP_RULES(GRAPHICS_VERSION_RANGE(2000, 2001), FUNC(xe_rtp_match_first_render_or_compute)),
	  XE_RTP_ACTIONS(SET(LSC_CHICKEN_BIT_0_UDW, XE2_ALLOC_DPA_STARVE_FIX_DIS))
	},
	{ XE_RTP_NAME("16018737384"),
	  XE_RTP_RULES(GRAPHICS_VERSION_RANGE(2000, 2001), FUNC(xe_rtp_match_first_render_or_compute)),
	  XE_RTP_ACTIONS(SET(ROW_CHICKEN, DISABLE_EARLY_EOT))
	},
	{ XE_RTP_NAME("14018957109"),
	  XE_RTP_RULES(GRAPHICS_VERSION_RANGE(2000, 2000),
		       FUNC(xe_rtp_match_first_render_or_compute)),
	  XE_RTP_ACTIONS(SET(HALF_SLICE_CHICKEN5, DISABLE_SAMPLE_G_PERFORMANCE))
	},
